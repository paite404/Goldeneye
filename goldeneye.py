...
╔══════════════════════════════════════════════════════════════════════╗
║                  GOLDEN EYE PROFESSIONAL v1.0                        ║
║           Advanced HTTP Load Testing & Stress Testing Tool           ║
╠══════════════════════════════════════════════════════════════════════╣
║  Developer: hack404 | Email: cybergurus@hotmail.com                  ║
║  Title: Professional Cyber Security & Network Engineer               ║
║  Based on original by Jan Seidl                                      ║
╚══════════════════════════════════════════════════════════════════════╝
"""
...
GOLDENEYE_BANNER = 'GoldenEye v1.0 by Stephen Paite hack404 hpps://github.com/paite404'
